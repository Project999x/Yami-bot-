...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7874044472:AAGfRq_y_tU6Gf9CmyXk002De7zHCLjXxzQ")
...
# NAMA OWNER
OWNER = os.environ.get("OWNER", "Yamiii_xBot")
#OWNER ID
...
DB_NAME = os.environ.get("DATABASE_NAME", "Yamiii_xBot")
#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002303321406"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002190790792"))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

START_PIC = os.environ.get("START_PIC", "https://envs.sh/r96.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://envs.sh/r9y.jpg")
...
try:
    ADMINS=[7149088701]
    for x in (os.environ.get("ADMINS", "1418213560 5261438298 7344678908 8034341907 6765266637").split()):
        ADMINS.append(int(x))
except ValueError:
